...
return [
    ...
    */
    ...
    'brand' => [
        'name' => 'Leekha',                      // Top-left sidebar & header
        'logo' => '/images/leekha-logo.png',     // Place logo in public/images
        'favicon' => '/images/favicon.ico',      // Optional favicon
    ],
    ...
    */
    ...
    'theme' => [
        'colors' => [
            'primary' => '#FF6B6B', // Leekha brand color
            'secondary' => '#4A5568', // Optional secondary color
        ],
    ],
